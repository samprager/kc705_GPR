...
%Noise_pwr = kboltz*BW_noise*T_noise
    
    
% meas_atten_c = (linkbudget.atten_loss)./(20*log10(exp(R_rx))+20*log10(exp(R_tx)));
%er_inv = (1/e0)*2*(meas_atten_c./w).^2