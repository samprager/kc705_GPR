...
#
# Generated by Vivado on Fri Jun 24 11:51:59 -0700 2016
...
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axi_s2mm_read.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axi_lite_sm.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axi_dma_0_exdes.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axis_write_master.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axis_sts_master.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axis_data_read.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axis_ctrl_read.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/dma/axi4_write_master.vhd"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/source/custom/reg_map_cmd_gen.v"
#    "d:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_traffic_gen_0/atg_data.coe"
#    "d:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_traffic_gen_0/atg_addr.coe"
#    "d:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_traffic_gen_0/atg_mask.coe"
#    "d:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_traffic_gen_0/atg_ctrl.coe"
#    "d:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/blk_mem_gen_0/sg_mif.coe"
...
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_bram_ctrl_0/axi_bram_ctrl_0.xci"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_bram_ctrl_1/axi_bram_ctrl_1.xci"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_dma_0/axi_dma_0.xci"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/axi_traffic_gen_0/axi_traffic_gen_0.xci"
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/ip/blk_mem_gen_0/blk_mem_gen_0.xci"
...
#    "D:/UndergroundRadar/kc705_GPR/Design/Firmware/sim/dma/axi_dma_0_exdes_tb.vhd"
#
...
set files [list \
 ...
 "[file normalize "$origin_dir/../ip/axi_traffic_gen_0/atg_data.coe"]"\
 "[file normalize "$origin_dir/../ip/axi_traffic_gen_0/atg_addr.coe"]"\
 "[file normalize "$origin_dir/../ip/axi_traffic_gen_0/atg_mask.coe"]"\
 "[file normalize "$origin_dir/../ip/axi_traffic_gen_0/atg_ctrl.coe"]"\
 "[file normalize "$origin_dir/../ip/blk_mem_gen_0/sg_mif.coe"]"\
]
...
# Create 'axi_bram_ctrl_0' fileset (if not found)
if {[string equal [get_filesets -quiet axi_bram_ctrl_0] ""]} {
  create_fileset -blockset axi_bram_ctrl_0
}

# Set 'axi_bram_ctrl_0' fileset object
set obj [get_filesets axi_bram_ctrl_0]
set files [list \
 "[file normalize "$origin_dir/../ip/axi_bram_ctrl_0/axi_bram_ctrl_0.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'axi_bram_ctrl_0' fileset file properties for remote files
# None

# Set 'axi_bram_ctrl_0' fileset file properties for local files
# None

# Set 'axi_bram_ctrl_0' fileset properties
set obj [get_filesets axi_bram_ctrl_0]
set_property "top" "axi_bram_ctrl_0" $obj

# Create 'axi_bram_ctrl_1' fileset (if not found)
if {[string equal [get_filesets -quiet axi_bram_ctrl_1] ""]} {
  create_fileset -blockset axi_bram_ctrl_1
}

# Set 'axi_bram_ctrl_1' fileset object
set obj [get_filesets axi_bram_ctrl_1]
set files [list \
 "[file normalize "$origin_dir/../ip/axi_bram_ctrl_1/axi_bram_ctrl_1.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'axi_bram_ctrl_1' fileset file properties for remote files
# None

# Set 'axi_bram_ctrl_1' fileset file properties for local files
# None

# Set 'axi_bram_ctrl_1' fileset properties
set obj [get_filesets axi_bram_ctrl_1]
set_property "top" "axi_bram_ctrl_1" $obj

# Create 'axi_dma_0' fileset (if not found)
if {[string equal [get_filesets -quiet axi_dma_0] ""]} {
  create_fileset -blockset axi_dma_0
}

# Set 'axi_dma_0' fileset object
set obj [get_filesets axi_dma_0]
set files [list \
 "[file normalize "$origin_dir/../ip/axi_dma_0/axi_dma_0.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'axi_dma_0' fileset file properties for remote files
# None

# Set 'axi_dma_0' fileset file properties for local files
# None

# Set 'axi_dma_0' fileset properties
set obj [get_filesets axi_dma_0]
set_property "top" "axi_dma_0" $obj

# Create 'axi_traffic_gen_0' fileset (if not found)
if {[string equal [get_filesets -quiet axi_traffic_gen_0] ""]} {
  create_fileset -blockset axi_traffic_gen_0
}

# Set 'axi_traffic_gen_0' fileset object
set obj [get_filesets axi_traffic_gen_0]
set files [list \
 "[file normalize "$origin_dir/../ip/axi_traffic_gen_0/axi_traffic_gen_0.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'axi_traffic_gen_0' fileset file properties for remote files
# None

# Set 'axi_traffic_gen_0' fileset file properties for local files
# None

# Set 'axi_traffic_gen_0' fileset properties
set obj [get_filesets axi_traffic_gen_0]
set_property "top" "axi_traffic_gen_0" $obj
...
# Create 'axi_bram_ctrl_0_synth_1' run (if not found)
if {[string equal [get_runs -quiet axi_bram_ctrl_0_synth_1] ""]} {
  create_run -name axi_bram_ctrl_0_synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2014} -strategy "Vivado Synthesis Defaults" -constrset axi_bram_ctrl_0
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs axi_bram_ctrl_0_synth_1]
  set_property flow "Vivado Synthesis 2014" [get_runs axi_bram_ctrl_0_synth_1]
}
set obj [get_runs axi_bram_ctrl_0_synth_1]
set_property "constrset" "axi_bram_ctrl_0" $obj

# Create 'axi_bram_ctrl_1_synth_1' run (if not found)
if {[string equal [get_runs -quiet axi_bram_ctrl_1_synth_1] ""]} {
  create_run -name axi_bram_ctrl_1_synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2014} -strategy "Vivado Synthesis Defaults" -constrset axi_bram_ctrl_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs axi_bram_ctrl_1_synth_1]
  set_property flow "Vivado Synthesis 2014" [get_runs axi_bram_ctrl_1_synth_1]
}
set obj [get_runs axi_bram_ctrl_1_synth_1]
set_property "constrset" "axi_bram_ctrl_1" $obj

# Create 'axi_dma_0_synth_1' run (if not found)
if {[string equal [get_runs -quiet axi_dma_0_synth_1] ""]} {
  create_run -name axi_dma_0_synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2014} -strategy "Vivado Synthesis Defaults" -constrset axi_dma_0
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs axi_dma_0_synth_1]
  set_property flow "Vivado Synthesis 2014" [get_runs axi_dma_0_synth_1]
}
set obj [get_runs axi_dma_0_synth_1]
set_property "constrset" "axi_dma_0" $obj

# Create 'axi_traffic_gen_0_synth_1' run (if not found)
if {[string equal [get_runs -quiet axi_traffic_gen_0_synth_1] ""]} {
  create_run -name axi_traffic_gen_0_synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2014} -strategy "Vivado Synthesis Defaults" -constrset axi_traffic_gen_0
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs axi_traffic_gen_0_synth_1]
  set_property flow "Vivado Synthesis 2014" [get_runs axi_traffic_gen_0_synth_1]
}
set obj [get_runs axi_traffic_gen_0_synth_1]
set_property "constrset" "axi_traffic_gen_0" $obj

# Create 'blk_mem_gen_0_synth_1' run (if not found)
if {[string equal [get_runs -quiet blk_mem_gen_0_synth_1] ""]} {
  create_run -name blk_mem_gen_0_synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2014} -strategy "Vivado Synthesis Defaults" -constrset blk_mem_gen_0
} else {
...
# Create 'axi_bram_ctrl_0_impl_1' run (if not found)
if {[string equal [get_runs -quiet axi_bram_ctrl_0_impl_1] ""]} {
  create_run -name axi_bram_ctrl_0_impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2014} -strategy "Vivado Implementation Defaults" -constrset axi_bram_ctrl_0 -parent_run axi_bram_ctrl_0_synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs axi_bram_ctrl_0_impl_1]
  set_property flow "Vivado Implementation 2014" [get_runs axi_bram_ctrl_0_impl_1]
}
set obj [get_runs axi_bram_ctrl_0_impl_1]
set_property "constrset" "axi_bram_ctrl_0" $obj

# Create 'axi_bram_ctrl_1_impl_1' run (if not found)
if {[string equal [get_runs -quiet axi_bram_ctrl_1_impl_1] ""]} {
  create_run -name axi_bram_ctrl_1_impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2014} -strategy "Vivado Implementation Defaults" -constrset axi_bram_ctrl_1 -parent_run axi_bram_ctrl_1_synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs axi_bram_ctrl_1_impl_1]
  set_property flow "Vivado Implementation 2014" [get_runs axi_bram_ctrl_1_impl_1]
}
set obj [get_runs axi_bram_ctrl_1_impl_1]
set_property "constrset" "axi_bram_ctrl_1" $obj

# Create 'axi_dma_0_impl_1' run (if not found)
if {[string equal [get_runs -quiet axi_dma_0_impl_1] ""]} {
  create_run -name axi_dma_0_impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2014} -strategy "Vivado Implementation Defaults" -constrset axi_dma_0 -parent_run axi_dma_0_synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs axi_dma_0_impl_1]
  set_property flow "Vivado Implementation 2014" [get_runs axi_dma_0_impl_1]
}
set obj [get_runs axi_dma_0_impl_1]
set_property "constrset" "axi_dma_0" $obj

# Create 'axi_traffic_gen_0_impl_1' run (if not found)
if {[string equal [get_runs -quiet axi_traffic_gen_0_impl_1] ""]} {
  create_run -name axi_traffic_gen_0_impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2014} -strategy "Vivado Implementation Defaults" -constrset axi_traffic_gen_0 -parent_run axi_traffic_gen_0_synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs axi_traffic_gen_0_impl_1]
  set_property flow "Vivado Implementation 2014" [get_runs axi_traffic_gen_0_impl_1]
}
set obj [get_runs axi_traffic_gen_0_impl_1]
set_property "constrset" "axi_traffic_gen_0" $obj

# Create 'blk_mem_gen_0_impl_1' run (if not found)
if {[string equal [get_runs -quiet blk_mem_gen_0_impl_1] ""]} {
  create_run -name blk_mem_gen_0_impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2014} -strategy "Vivado Implementation Defaults" -constrset blk_mem_gen_0 -parent_run blk_mem_gen_0_synth_1
} else {
